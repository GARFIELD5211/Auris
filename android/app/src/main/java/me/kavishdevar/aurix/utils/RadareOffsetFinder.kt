...
package me.kavishdevar.aurix.utils
...
import me.kavishdevar.aurix.services.ServiceManager
...
class RadareOffsetFinder(context: Context) {
    companion object {
        ...
        private const val HOOK_OFFSET_PROP = "persist.auris.hook_offset"
        private const val CFG_REQ_OFFSET_PROP = "persist.auris.cfg_req_offset"
        private const val CSM_CONFIG_OFFSET_PROP = "persist.auris.csm_config_offset"
        private const val PEER_INFO_REQ_OFFSET_PROP = "persist.auris.peer_info_req_offset"
        private const val SDP_OFFSET_PROP = "persist.auris.sdp_offset"
