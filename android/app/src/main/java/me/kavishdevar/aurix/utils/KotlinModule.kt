...
private const val TAG = "AurisHook"
        ...
        if (param.packageName == "com.google.android.bluetooth" || param.packageName == "com.android.bluetooth") {
            ...
            try {
                if (param.isFirstPackage) {
                    ...
                    val remotePrefValue = getRemotePreferences("me.kavishdevar.aurix").getBoolean("vendor_id_hook", false)
        ...
        try {
            ...
            hook(updateIconMethod).intercept { chain ->
                try {
                    ...
                    if (!uri.toString().startsWith("android.resource://me.kavishdevar.aurix")) {
                        return@intercept chain.proceed()
                    }
