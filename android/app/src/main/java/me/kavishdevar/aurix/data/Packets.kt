...
class AirPodsNotifications {
    companion object {
        const val AIRPODS_CONNECTED = "me.kavishdevar.aurix.AIRPODS_CONNECTED"
        const val AIRPODS_L2CAP_CONNECTED = "me.kavishdevar.aurix.AIRPODS_CONNECTED"
        const val AIRPODS_DATA = "me.kavishdevar.aurix.AIRPODS_DATA"
        const val EAR_DETECTION_DATA = "me.kavishdevar.aurix.EAR_DETECTION_DATA"
        const val ANC_DATA = "me.kavishdevar.aurix.ANC_DATA"
        const val BATTERY_DATA = "me.kavishdevar.aurix.BATTERY_DATA"
        const val CA_DATA = "me.kavishdevar.aurix.CA_DATA"
        const val AIRPODS_DISCONNECTED = "me.kavishdevar.aurix.AIRPODS_DISCONNECTED"
        const val AIRPODS_CONNECTION_DETECTED = "me.kavishdevar.aurix.AIRPODS_CONNECTION_DETECTED"
        const val DISCONNECT_RECEIVERS = "me.kavishdevar.aurix.DISCONNECT_RECEIVERS"
        const val EQ_DATA = "me.kavishdevar.aurix.HEADPHONE_ACCOMMODATION"
        const val AIRPODS_INFORMATION_UPDATED = "me.kavishdevar.aurix.AIRPODS_INFORMATION_UPDATED"
    }
